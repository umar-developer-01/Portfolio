...
const Header = () => {
  ...
  return (
    <header className="mt-10 sticky md:relative top-5 z-20 md:mt-20 mx-auto max-w-7xl px-6 md:px-12 lg:px-6 xl:px-0">
    <nav className="bg-gray-900 rounded-xl md:rounded-s-full md:rounded-e-full">
      ...
      <div className={`sm:hidden fixed  w-[calc(100%_-_10rem)] h-[calc(100%_-_10rem)] bg-gray-900/90 backdrop-blur-[10px] transition-all duration-500 rounded-xl ${isToggled ? 'left-6' : '-left-full'}`} id="mobile-menu">
