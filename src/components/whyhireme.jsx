        ...
        <div className="mx-auto max-w-6xl px-6 md:px-12 lg:px-6 xl:px-0">
          <div className="mx-auto flex flex-col items-center gap-6 sm:w-4/5 md:w-full md:flex-row lg:gap-12">
            ...
            <div className="ml-auto h-full md:w-1/2">
              <h3 className="md:text-6xl xl:text-5xl font-black text-gray-900 dark:text-white">
                Why <span className="text-orange-600">Hire me</span>?
              </h3>
              ...
              <div className="flex">
                <a
                  href="/register"
                  className="bg-orange-400 rounded-s-full px-10 py-3 rounded-e-full"
                >
                  <span className="text-white astro-Z4ZYBUMP">Hire me</span>
                </a>
              </div>
            </div>
          </div>
