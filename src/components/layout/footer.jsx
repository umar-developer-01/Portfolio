        ...
        <div className="m-auto space-y-8 px-4 text-gray-400 hover:text-gray-3  sm:px-12 xl:max-w-7xl xl:px-0">
          <div className="flex h-full items-center justify-center gap-6  py-6 dark:border-gray-800 flex-col md:py-0">
            <div className="max-w-md text-center gap-6 flex justify-center flex-col items-center">
              ...
              >
                <img
                  className="font-semibold w-12 h-12 bg-orange-600 rounded-full"
                  src={Logo}
                  alt="Umar"
                />
                <span class="text-xl text-white font-bold uppercase">Umar</span>
              </a>
              <a href="https://tailus.io" className="inline-block text-sm">
                Developed by Umar Khan and coded in{" "}
                <span className=" text-white"> in Visual Studio Code</span> by
                yours truly. Built with{" "}
                <span className=" text-white">ReactJS</span> and{" "}
                <span className=" text-white">Tailwind CSS</span>. All text is
